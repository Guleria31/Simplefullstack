...
export class Employee extends Component{
    ...
    constructor(props){
        ...
        this.state={
            ...
            EmployeeIdFilter: "",  // Filter for Employee ID
            EmployeeNameFilter: "",  // Filter for Employee Name
            employeesWithoutFilter: [],  // Employee data without filters
    ...
    FilterEmployees() {
    const { EmployeeIdFilter, EmployeeNameFilter, DepartmentFilter,employeesWithoutFilter } = this.state;
    
    const filteredData = employeesWithoutFilter.filter((el) => {
      return (
        el.EmployeeId.toString().toLowerCase().includes(EmployeeIdFilter.toString().trim().toLowerCase()) &&
  ...
  // Function to handle changes in Employee ID filter input
...
//   // Function to handle changes in Employee Name filter input
//   changeEmployeeNameFilter = this.myFunction;
...
// }
    ...
    render(){
        ...
        const divStyle = {
            backgroundColor: 'LightGray', // Replace with your desired background color
            height: 'cover', // Adjust as needed
...
<div class="px-5">
    ...
    <tr>
        ...
        <input
          ...
          value={this.state.EmployeeIdFilter}
        ...
        <input
          ...
          value={this.state.EmployeeNameFilter}
